...
const STRINGS := {
	...
	"help_wall_mode_body": {"en": "A third online option, next to Online Mode and Quick Online Mode, connected the same way (Create Room or Join Room). The court's side walls are in play - a shot spun hard enough to normally sail out to the side instead bounces off that wall with a distinct thump and carries on into play, landing on the opposite side of the court instead of faulting. To help you get across in time, press D-pad Left/Right on a controller, or hold F and press the Left/Right arrow key, to jump straight to that side's edge tile, skipping the middle. You also get one Super Smash per game: hold the left trigger (or J) and press the smash button while holding it - same timing as a regular smash, any time a ball is dollied on your side, no extra window to time. Press smash without the trigger held, or on a ball that isn't dollied, and it's just a regular smash instead. You'll hear \"Super Smash!\" announced, and the ball doesn't actually get hit until that finishes, so your opponent has a real chance to react before it arrives. A Super Smash can't be spun (holding a direction does nothing), has its own distinct impact sound, and crosses much faster than a normal smash once it's hit - genuinely difficult to return, though never impossible. Scoring works differently here too: points race up with no cap, first to five, reachable however you like. Reaching five doesn't win by itself - it just makes you eligible - and any point after that must be won specifically with a smash to end the match; a normal point win once you're past five just keeps the match going.",
			"es": "Una tercera opción en línea, junto a Modo en línea y Modo rápido en línea, con la misma forma de conectar (Crear sala o Unirse a sala). Las paredes laterales de la pista están en juego - un golpe con suficiente efecto como para salir normalmente por el lateral en su lugar rebota en esa pared con un golpe seco distintivo y sigue en juego, cayendo en el lado opuesto de la pista en vez de ser falta. Para ayudarte a llegar a tiempo, pulsa D-pad izquierda/derecha en un mando, o mantén pulsada F y pulsa la flecha izquierda/derecha, para saltar directamente a la casilla del borde de ese lado, saltándote el centro. También tienes un Súper remate por partida: mantén pulsado el gatillo izquierdo (o J) y pulsa el botón de remate mientras lo mantienes pulsado - el mismo momento que un remate normal, en cualquier momento en que la pelota esté globeada en tu lado, sin ninguna ventana extra que calcular. Si pulsas remate sin el gatillo pulsado, o con una pelota que no esté globeada, es simplemente un remate normal. Escucharás el anuncio \"¡Súper remate!\", y la pelota no se golpea de verdad hasta que termine, para que tu rival tenga una oportunidad real de reaccionar antes de que llegue. Un Súper remate no se puede dar con efecto (mantener una dirección no hace nada), tiene su propio sonido de impacto distintivo, y cruza mucho más rápido que un remate normal una vez golpeada - genuinamente difícil de devolver, aunque nunca imposible. La puntuación también funciona distinto aquí: los puntos suben sin límite, el primero en llegar a cinco, como sea. Llegar a cinco no gana por sí solo - solo te hace elegible - y cualquier punto después de eso debe ganarse específicamente con un remate para terminar el partido; ganar un punto normal una vez que ya superaste cinco simplemente continúa la partida."},
	...
	"wall_online_mode_desc": {"en": "The court's side walls are in play - a shot that would go out bounces off the wall into play on the opposite side instead. First to five points, however you like - then win a point with a smash to win the match. See Help for the side-dash and Super Smash moves this mode adds.",
			"es": "Las paredes laterales de la pista están en juego - un golpe que saldría fuera rebota en la pared y sigue en juego en el lado opuesto. El primero en llegar a cinco puntos, como sea - luego gana un punto con un remate para ganar el partido. Consulta la Ayuda para ver los movimientos de esquive lateral y Súper remate que añade este modo."},
	...
	"emote_reggae_vibes": {"en": "Reggae Vibes", "es": "Ambiente reggae"},
	"emote_pirate_shanty": {"en": "Pirate Shanty", "es": "Cantar de piratas"},
	"emote_sweaty_line": {"en": "Sweaty Balls", "es": "Pelotas sudadas"},
	"emote_pirate_joke": {"en": "Pirate's Favorite Letter", "es": "La letra favorita del pirata"},
	"emote_thunder_strike": {"en": "Thunder Strike", "es": "Golpe de trueno"},
	"emote_level_up": {"en": "Level Up", "es": "Subida de nivel"},
	"emote_country_twang": {"en": "Country Twang", "es": "Toque country"},
	"emote_disco_groove": {"en": "Disco Groove", "es": "Ritmo disco"},
	"emote_kpop_wave": {"en": "K-Pop Wave", "es": "Ola K-pop"},
	"emote_rnb_smooth": {"en": "R&B Smooth", "es": "R&B suave"},
	"emote_jazz_lounge": {"en": "Jazz Lounge", "es": "Salón de jazz"},
	"emote_classical_strings": {"en": "Classical Strings", "es": "Cuerdas clásicas"},
	"emote_blues_riff": {"en": "Blues Riff", "es": "Riff de blues"},
	"emote_funk_fever": {"en": "Funk Fever", "es": "Fiebre funk"},
	"emote_rock_riff": {"en": "Rock Riff", "es": "Riff de rock"},
	"emote_edm_pulse": {"en": "EDM Pulse", "es": "Pulso EDM"},
	"emote_metal_riff": {"en": "Metal Riff", "es": "Riff metal"},
	"emote_flamenco_fire": {"en": "Flamenco Fire", "es": "Fuego flamenco"},
	"emote_soul_groove": {"en": "Soul Groove", "es": "Ritmo soul"},
	"emote_polka_party": {"en": "Polka Party", "es": "Fiesta de polca"},
	"emote_techno_pulse": {"en": "Techno Pulse", "es": "Pulso techno"},
	"emote_punk_energy": {"en": "Punk Energy", "es": "Energía punk"},
	"emote_house_beat": {"en": "House Beat", "es": "Ritmo house"},
	"emote_dubstep_wobble": {"en": "Dubstep Wobble", "es": "Wobble dubstep"},
	"emote_arabian_nights": {"en": "Arabian Nights", "es": "Noches árabes"},
	"emote_waltz_ballroom": {"en": "Ballroom Waltz", "es": "Vals de salón"},
