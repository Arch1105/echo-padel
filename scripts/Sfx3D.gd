...
const SOUNDS := {
	...
	"kpop_wave": preload("res://audio/emotes/kpop_wave.wav"),
	"rnb_smooth": preload("res://audio/emotes/rnb_smooth.wav"),
	"jazz_lounge": preload("res://audio/emotes/jazz_lounge.wav"),
	"classical_strings": preload("res://audio/emotes/classical_strings.wav"),
	"blues_riff": preload("res://audio/emotes/blues_riff.wav"),
	"funk_fever": preload("res://audio/emotes/funk_fever.wav"),
	"rock_riff": preload("res://audio/emotes/rock_riff.wav"),
	"edm_pulse": preload("res://audio/emotes/edm_pulse.wav"),
	"metal_riff": preload("res://audio/emotes/metal_riff.wav"),
	"flamenco_fire": preload("res://audio/emotes/flamenco_fire.wav"),
	"soul_groove": preload("res://audio/emotes/soul_groove.wav"),
	"polka_party": preload("res://audio/emotes/polka_party.wav"),
	"techno_pulse": preload("res://audio/emotes/techno_pulse.wav"),
	"punk_energy": preload("res://audio/emotes/punk_energy.wav"),
	"house_beat": preload("res://audio/emotes/house_beat.wav"),
	"dubstep_wobble": preload("res://audio/emotes/dubstep_wobble.wav"),
	"arabian_nights": preload("res://audio/emotes/arabian_nights.wav"),
	"waltz_ballroom": preload("res://audio/emotes/waltz_ballroom.wav"),
}
